...
var ret = numeros.filter(filtrar_pares);  // gerar um novo array com numeros pares
// console.log(ret);

ret = numeros.filter(filtrar_impares);  // gerar um novo array com numeros impares
// console.log(ret);

ret = numeros.filter(filtrar_multiplos_5);  // gerar um novo array com numeros multiplos de 5
// console.log(ret);
